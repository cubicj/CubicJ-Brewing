...
import type { BrewFlowSelection, EquipmentSettings, FilterRecord, GrinderConfig } from '../../../brew/types';
import { renderConfigureDials } from './ConfigureDials';

vi.mock('../../../i18n/index', () => ({ t: (key: string) => key, initI18n: vi.fn() }));
